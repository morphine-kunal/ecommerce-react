...
const ProductDescription = ({ description }) => {
  ...
  const [isFeatureClicked, setIsFeatureClick] = useState(true);
  const [isDescriptionClicked, setIsDescriptionClicked] = useState(false);

  const handleFeatureClick = () => {
    setShowFeatures(!showFeatures);
    setShowDescription(false);
    setIsFeatureClick(!isFeatureClicked);
    ...
    <div className="mt-3">
      <div className="w-56 flex justify-between items-center">
        <TabBtn
          ...
          bgc={isFeatureClicked ? "bg-black text-white" : ""}
        />
        <TabBtn
          name="Description"
          click={handleDescriptionClick}
          bgc={isDescriptionClicked ? "bg-black text-white" : ""}
        />
      </div>
      ...
      {showDescription && (
        <div className="bg-white p-5 mt-3 rounded-md">
          ...
          <div className="text-xs md:text-base">
            ...
            reprehenderit, consectetur possimus dicta quibusdam nam fuga eos
            facere ab quod consequatur dolor tenetur omnis autem quaerat aut
            culpa nihil quis unde impedit. Quo sint ipsum harum velit impedit
            dolorem delectus hic maxime saepe, ipsam, non itaque commodi, totam
            eos eaque? Deserunt cumque nisi ducimus corporis quis, velit
            voluptates molestiae quod quidem, alias maxime distinctio at
            pariatur omnis, illo inventore culpa. Sapiente est commodi eos animi
            labore consequuntur, impedit accusantium, consectetur eligendi
            numquam at non molestias nostrum odio! Ad quibusdam blanditiis
            maiores quo veniam? Dicta voluptatum quibusdam hic sunt?
